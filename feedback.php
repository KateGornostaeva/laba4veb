...
<div class="site_page_feedback">
    <form action="https://httpbin.org/post" method="post">
        ...
        <p>ФИО</p>
        <p><input type="text" id = "fio" name="fio" size="40"></p>

        <p>Электронная почта</p>
        <p><input type="text" id = "email" name = "email" placeholder="email" size="40"></p>
        ...
        <p><input type="radio" name="answer" value="a1">Реклама из интернета<Br>
        <input type="radio" name="answer" value="a2">Рассказали друзья<Br>
